# Image Annotator Reference Index

This directory contains detailed reference documentation for the Image Annotator skill.

## Reference Files

- **[portability.md](./portability.md)**: Guidelines for installing and using this skill across different agent environments.
